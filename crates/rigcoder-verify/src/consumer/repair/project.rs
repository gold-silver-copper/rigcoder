...
pub(super) fn initial() -> Image {
    [
        (
            "Cargo.toml",
            include_str!("../../../../../harness/repair-project/Cargo.toml"),
        ),
        (
            "Cargo.lock",
            include_str!("../../../../../harness/repair-project/Cargo.lock"),
        ),
        (
            "README.md",
            include_str!("../../../../../harness/repair-project/README.md"),
        ),
        (
            "src/lib.rs",
            include_str!("../../../../../harness/repair-project/src/lib.rs"),
        ),
        (
            "tests/pagination.rs",
            include_str!("../../../../../harness/repair-project/tests/pagination.rs"),
        ),
    ]
    .into_iter()
